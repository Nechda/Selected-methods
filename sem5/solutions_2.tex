...
\begin{document} 
	...
	\[1 \ge \sin^2\phi\]
	\begin{figure}[h!]
		\center{\includegraphics[scale=0.4]{sketch.png}}
	\end{figure}
	...
	\begin{figure}[h!]
		\center{\includegraphics[scale=0.35]{limitation.png}}
	...
	\begin{figure}[h!]
		\center{\includegraphics[scale=0.5]{segments.png}}
	...
	\begin{figure}[h!]
		\center{\includegraphics[scale=0.37]{displacement.png}}
	\end{figure}
